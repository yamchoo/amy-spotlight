     ...
     >
      ...
      <div className="mt-6 flex">
        <input
          ...
          required
          className="min-w-0 flex-auto appearance-none rounded-md border border-zinc-900/10 bg-white px-3 py-[calc(theme(spacing.2)-1px)] shadow-md shadow-zinc-800/5 placeholder:text-zinc-400 focus:border-pink-500 focus:outline-none focus:ring-4 focus:ring-pink-500/10 sm:text-sm dark:border-zinc-700 dark:bg-pink-700/[0.15] dark:text-zinc-200 dark:placeholder:text-zinc-500 dark:focus:border-pink-400 dark:focus:ring-pink-400/10"
        />
...
function Role({ role }: { role: Role }) {
  ...
  return (
    <li className="flex gap-4">
      <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-pink-800 dark:ring-0">
